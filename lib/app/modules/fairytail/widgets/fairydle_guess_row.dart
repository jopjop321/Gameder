...
class FairydleGuessRow extends StatefulWidget {
  final FairytailGuessResult result;
  final bool animate;

  const FairydleGuessRow({
    super.key,
  ...
  @override
  State<FairydleGuessRow> createState() => _FairydleGuessRowState();
}

class _FairydleGuessRowState extends State<FairydleGuessRow>
  ...
  Color _matchColor(FairytailMatch match) {
    switch (match) {
      case FairytailMatch.correct:
        return kFairytailCorrectColor;
      case FairytailMatch.partial:
        return kFairytailPartialColor;
      case FairytailMatch.incorrect:
        return kFairytailIncorrectColor;
    }
  }
}

class _FairydleFlipCell extends StatelessWidget {
  final Animation<double> animation;
  final Widget child;

  const _FairydleFlipCell({required this.animation, required this.child});
...
class _FairydleNameCellContent extends StatelessWidget {
  final FairytailCharacter character;
  final Color color;

  const _FairydleNameCellContent({required this.character, required this.color});
...
class _FairydleCellContent extends StatelessWidget {
  final String value;
  final Color color;

  const _FairydleCellContent({required this.value, required this.color});
