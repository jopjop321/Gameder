...
Future<BleachCharacter?> showBleachDexDialog(
  BuildContext context,
  List<BleachCharacter> availableCharacters,
) {
  final searchController = TextEditingController();
  var selectedAffiliation = 'ทั้งหมด';

  return showDialog<BleachCharacter>(
    context: context,
    builder: (dialogContext) => StatefulBuilder(
      builder: (context, setModalState) {
        ...
        return Dialog(
          backgroundColor: kBleachPanelColor,
                  ...
                  child: Row(
                    children: [
                      const Icon(
                        ...
                        color: kBleachAccentColor,
                      ),
                      const SizedBox(width: 8),
                      Expanded(
                        child: Text(
                          'bleach_dexTitle'.trParams(
                    ...
                    children: [
                      Expanded(
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            hintText: 'bleach_dexSearchHint'.tr,
                      ...
                      SizedBox(
                        ...
                        child: DropdownButtonFormField<String>(
                          ...
                          isExpanded: true,
                          dropdownColor: kBleachPanelColor,
                          style: const TextStyle(color: Colors.white),
                          decoration: InputDecoration(
                            isDense: true,
                            filled: true,
                          ...
                          items: [
                            DropdownMenuItem(
                              value: 'ทั้งหมด',
                              child: Text('bleach_dexAllAffiliations'.tr),
                            ),
                            ...affiliations.map(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        leading: CircleAvatar(
                          backgroundColor: kBleachHeaderCellColor,
