...
class CloverdleGuessRow extends StatefulWidget {
  final BlackcloverGuessResult result;
  final bool animate;

  const CloverdleGuessRow({
    super.key,
  ...
  @override
  State<CloverdleGuessRow> createState() => _CloverdleGuessRowState();
}

class _CloverdleGuessRowState extends State<CloverdleGuessRow>
  ...
  Color _matchColor(BlackcloverMatch match) {
    switch (match) {
      case BlackcloverMatch.correct:
        return kBlackcloverCorrectColor;
      case BlackcloverMatch.partial:
        return kBlackcloverPartialColor;
      case BlackcloverMatch.incorrect:
        return kBlackcloverIncorrectColor;
    }
  }
}

class _CloverdleFlipCell extends StatelessWidget {
  final Animation<double> animation;
  final Widget child;

  const _CloverdleFlipCell({required this.animation, required this.child});
...
class _CloverdleNameCellContent extends StatelessWidget {
  final BlackcloverCharacter character;
  final Color color;

  const _CloverdleNameCellContent({required this.character, required this.color});
...
class _CloverdleCellContent extends StatelessWidget {
  final String value;
  final Color color;

  const _CloverdleCellContent({required this.value, required this.color});
